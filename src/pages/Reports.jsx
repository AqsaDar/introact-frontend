...
function Reports() {
  ...
  const FunnelStep = ({ data, index, isLast }) => {
    const percentage = index === 0 ? 100 : ((data.count / reportsData.conversionFunnel[0].count) * 100).toFixed(1);
    ...
    return (
      <div className="relative">
        <div className="flex items-center space-x-4 mb-2">
          <div 
            className="bg-blue-600 text-white px-4 py-3 rounded-lg flex-1 text-center font-medium text-sm relative"
            style={{ 
              width: `${width}%`,
              minWidth: '200px',
              clipPath: isLast ? 'none' : 'polygon(0 0, calc(100% - 20px) 0, 100% 50%, calc(100% - 20px) 100%, 0 100%)'
            }}
          >
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600">Comprehensive performance analysis of your AI outreach campaigns</p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 mb-8">
        ...
        <div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-lg font-semibold text-gray-900">Sector Breakdown</h3>
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <RechartsPieChart>
                  ...
                  <Tooltip formatter={(value, name, props) => [`${value} companies`, props.payload.sector]} />
                </RechartsPieChart>
              </ResponsiveContainer>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
          <div className="flex items-center space-x-3 mb-3">
            ...
            <h4 className="font-semibold text-blue-900">Top Performing Sector</h4>
          </div>
          <p className="text-blue-800 text-sm mb-2">
            <span className="font-bold">SaaS companies</span> show the highest conversion rate at 
            <span className="font-bold"> 28.1%</span> of all shortlisted leads.
          </p>
          <p className="text-xs text-blue-600">Focus outreach efforts on SaaS prospects for better ROI</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200">
          ...
          <p className="text-green-800 text-sm mb-2">
            <span className="font-bold">94.2%</span> of uploaded leads pass AI validation, 
            indicating high-quality data sources.
          </p>
          <p className="text-xs text-green-600">Maintain current data sourcing strategies</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-6 border border-orange-200">
          <div className="flex items-center space-x-3 mb-3">
            ...
            <h4 className="font-semibold text-orange-900">Call Conversion</h4>
          </div>
          <p className="text-orange-800 text-sm mb-2">
            <span className="font-bold">57.1%</span> of completed calls result in shortlisted prospects, 
            showing strong AI call quality.
          </p>
          <p className="text-xs text-orange-600">AI calling system is performing exceptionally well</p>
        </div>
      </div>
