      ...
      {isInitializing && (
        <div style={{
          ...
          <div>
            ...
            <div style={{fontSize: 12, color: '#6b7280'}}>Please wait while we initialize the audio call.</div>
          </div>
          ...
          <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:16}}>
            <div style={{display:'flex', alignItems:'center', gap:12}}>
              ...
              <div>
                ...
                <div style={{fontSize:12, color:'#6b7280'}}>Duration {formatTime(callSeconds)}</div>
              </div>
            </div>
            <button
              onClick={endCall}
              ...
              transcript.map((msg, i) => (
                <div key={i} style={{ marginBottom: 8, textAlign: msg.role === 'user' ? 'right' : 'left' }}>
                  <span style={{
                    ...
                    display: 'inline-block', fontSize: 14, maxWidth: '80%'
                  }}>
                    {msg.text}
                  </span>
                </div>
